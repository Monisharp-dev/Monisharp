...
allotTaskBalance("femigodslove069",30,"0000B");
allotTaskBalance("etokwudog",10,"0000K");
allotTaskBalance("idrisamuda06",30,"0000B");
allotTaskBalance("damilolaabolade332",20,"0000B");
allotTaskBalance("whizzyboss67",10,"0000B")
