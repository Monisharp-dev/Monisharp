...
allotTaskBalance("chrisfaith323", 12, "4X2YI");
...
allotTaskBalance("gift36385", 10, "A83ZD");
...
allotTaskBalance("kennedjohnson37", 15, "AXURQ");
...
allotTaskBalance("goodnesskolawole35", 10, "KBLML");
allotTaskBalance("opeyemiisiaq69", 13, "1M1N1");
allotTaskBalance("beautistar24", 15, "IJ1FZ");
allotTaskBalance("olawanletimileyin3", 11, "G404G");
...
allotTaskBalance("okaforrichard21", 11, "KN9QU");
allotTaskBalance("blossomoaksgrandempire01", 13, "VDA01");
allotTaskBalance("princewillakpan007", 38, "EEZGV");
allotTaskBalance("Divinemercypastry", 15, "ERIGH");
