...
allotTaskBalance("richesosimejom", 6, "O7JMD");
allotTaskBalance("etokwudog", 10, "ERZBM");
allotTaskBalance("opalekesoromdayo", 20, "FZILC");
allotTaskBalance("Goodluckn673", 50, "000SA");
allotTaskBalance("eyodavid386", 30, "SE92I");
allotTaskBalance("richesosimejom", 31, "000SE");